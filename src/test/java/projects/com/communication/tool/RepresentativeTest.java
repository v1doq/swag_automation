...
import projects.com.communication.tool.steps.RepresentativeStep;
...
@Feature("Campaign")
@Story("Functional tests for representative")
public class RepresentativeTest extends SuiteTestCT {
    ...
    @Test(groups = "sanity reps", dataProvider = "Reps", description = "Create valid representative")
